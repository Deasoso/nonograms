<template>
  <div class="loader">
    ...
    <img class="finish_board" src="http://pic.deaso40.com/ljhy/3基础教程/2/示例图4.png" />
    <img class="star" src="http://pic.deaso40.com/ljhy/4地图/星星.png" />
    <div class="star-num">{{stars}}</div>
    <img class="finish_title" src="http://pic.deaso40.com/ljhy/3基础教程/2/图案完成.png" />
    <img class="finish_girl" src="http://pic.deaso40.com/ljhy/关卡背景补充/人物.png" />
    <transition name="quickfade">
      <img v-show="dialogShowed" class="finish_dialog" src="http://pic.deaso40.com/ljhy/3基础教程/2/对话14.png" />
    </transition>
  ...
  methods: {
    ...
    starStyle(index){
      ...
      if(this.successStar == 3){
        if(index == 0){ styledata.left = 'calc(50vw - 80px)'; styledata.top = '110px'; }
        else if(index == 1){ styledata.left= 'calc(50vw - 30px)'; styledata.top = '98px'; }
        else { styledata.right = 'calc(50vw - 80px)'; styledata.top = '110px'; }
      }
      return styledata;
    }
  }
