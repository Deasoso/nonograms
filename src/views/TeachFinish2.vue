<template>
  <div class="loader">
    ...
    <img class="finish_board" src="http://pic.deaso40.com/ljhy/示例图5/示例图5.png" />
    ...
    <transition name="quickfade">
      <img v-show="dialogShowed" class="finish_dialog" src="http://pic.deaso40.com/ljhy/9清明/1进阶教程/对话16.png" />
    </transition>
