<template>
  <div id="gameFieldWrapper" ref="fieldLayout" :style="cssVariables">
    <div id="field" ref="gameField">
      ...
      <img :style="backStyle(0)" v-if="showLine(1)" src="http://pic.deaso40.com/ljhy/3基础教程/2/格子复制.png" />
      <img :style="backStyle(1)" v-if="showLine(2)"  src="http://pic.deaso40.com/ljhy/3基础教程/2/格子复制 6.png" />
      <img :style="backStyle(2)" v-if="showLine(3)"  src="http://pic.deaso40.com/ljhy/3基础教程/2/格子复制 6.png" />
      <img :style="backStyle(3)" v-if="showLine(4)"  src="http://pic.deaso40.com/ljhy/3基础教程/2/格子复制 6.png" />
      <img :style="backStyle(4)" v-if="showLine(5)"  src="http://pic.deaso40.com/ljhy/3基础教程/2/格子复制 14.png" />
  ...
  methods: {
    update_step(){
      ...
      if(this.filledCells[1][1] && 
        ...
        this.filledCells[3][1] && 
        this.filledCells[4][1] && 
        this.filledCells[5][1] &&
        this.pic_step == 44){
          this.$emit('nextpic');
      }
      if(this.filledCells[1][2] && 
        this.filledCells[2][2] && 
        this.filledCells[3][2] && 
        this.filledCells[4][2] && 
        this.pic_step == 49){
          this.$emit('nextpic');
      }
      if(this.filledCells[5][3] && 
        this.filledCells[2][3] && 
        this.filledCells[3][3] && 
        this.filledCells[4][3] && 
        this.pic_step == 54){
          this.$emit('nextpic');
      }
      if(this.filledCells[1][4] && 
        this.filledCells[3][4] && 
        this.filledCells[4][4] && 
        this.filledCells[5][4] && 
        this.pic_step == 64){
          this.$emit('nextpic');
      }
      if(this.filledCells[3][5] &&
        this.pic_step == 79){
          this.$emit('nextpic');
      }
    },
    ...
    backStyle(y){
      return {
        position: 'absolute',
        width: ((this.cellSize * this.fieldWidth) + 40) + 'px',
        height: (this.cellSize + 40) + 'px',
        top: ((this.game_top + 56) + ((this.cellSize) * y)) + 'px',
        left: (this.game_left + 53) + 'px',
        'z-index': '50'
      }
    },
    smallBackStyle(){
